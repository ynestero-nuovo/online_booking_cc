...
export const CATALOG_SERVICES: CatalogService[] = [
  ...
  { id: "svc-88", name: "Чистка гідропілінг (гідрофлінг з алмазним пілінгом, чистка+ маска по проблематиці шкіри)", categoryId: "cat-7", durationMin: 90, price: 3200, providers: ["kovbasa"] },
  { id: "svc-89", name: "Комбінована чистка обличчя + азелоїново-саліциловий пілінг обличчя", categoryId: "cat-7", durationMin: 90, price: 2000, providers: ["kovbasa"] },
  { id: "svc-90", name: "Комбінована чистка спини + азелоїново-саліциловий пілінг спини", categoryId: "cat-7", durationMin: 120, price: 3500, providers: ["kovbasa"] },
  { id: "svc-91", name: "Комбінована чистка спини", categoryId: "cat-7", durationMin: 90, price: 2500, providers: ["kovbasa"] },
  { id: "svc-92", name: "Комбінована чистка обличчя + пілінг обличчя APPeex", categoryId: "cat-7", durationMin: 90, price: 3200, providers: ["kovbasa"] },
  { id: "svc-93", name: "Комбінована чистка обличчя + пілінг обличчя BioRePeel", categoryId: "cat-7", durationMin: 90, price: 3200, providers: ["kovbasa"] },
  { id: "svc-94", name: "Комбінована чистка обличчя Clear Choice", categoryId: "cat-7", durationMin: 90, price: 3000, providers: ["kovbasa"] },
  { id: "svc-95", name: "Комбінована чистка обличчя + пілінг обличчя Quick Peel", categoryId: "cat-7", durationMin: 90, price: 2700, providers: ["kovbasa"] },
  { id: "svc-96", name: "Комбінована чистка обличчя + фотоомолодження обличчя IPL Lumecca + пілінг обличчя BioRePeel", categoryId: "cat-7", durationMin: 90, price: 6000, providers: ["kovbasa"] },
  { id: "svc-97", name: "Комбінована чистка обличчя + фотоомолодження обличчя IPL Lumecca + пілінг обличчя APPeex", categoryId: "cat-7", durationMin: 90, price: 7000, providers: ["kovbasa"] },
  { id: "svc-98", name: "Комбінована чистка обличчя + ферментотерапія обличчя 1 маска", categoryId: "cat-7", durationMin: 90, price: 3900, providers: ["kovbasa"] },
  { id: "svc-99", name: "Комбінована чистка обличчя + ферментотерапія обличчя повний протокол", categoryId: "cat-7", durationMin: 90, price: 5000, providers: ["kovbasa"] },
  { id: "svc-100", name: "Комбінована чистка спини + Пілінг Acne Peel", categoryId: "cat-7", durationMin: 120, price: 5400, providers: ["kovbasa"] },
  { id: "svc-101", name: "Масаж обличчя та зони декольте + лімфодренаж 30хв", categoryId: "cat-8", durationMin: 30, price: 1300, providers: ["kovbasa"] },
  { id: "svc-102", name: "Масаж обличчя та зони декольте + лімфодренаж 60хв", categoryId: "cat-8", durationMin: 60, price: 2000, providers: ["kovbasa"] },
  { id: "svc-103", name: "Масаж обличчя та зони декольте + лімфодренаж 90хв", categoryId: "cat-8", durationMin: 90, price: 2600, providers: ["kovbasa"] },
  { id: "svc-104", name: "Масаж обличчя  для проблемної шкіри(гідропілінг+масаж), зони декольте  + лімфодренаж", categoryId: "cat-8", durationMin: 90, price: 5700, providers: ["kovbasa"] },
  { id: "svc-105", name: "Гідропілінг на апараті EVE Ace of Face", categoryId: "cat-9", durationMin: 60, price: 1600, providers: ["kovbasa"] },
  { id: "svc-106", name: "Мікротоки на апараті Eve Ace of Face", categoryId: "cat-9", durationMin: 60, price: 1400, providers: ["kovbasa"] },
  { id: "svc-107", name: "Елктро міостимуляція EVE Ace of Face", categoryId: "cat-9", durationMin: 60, price: 1400, providers: ["kovbasa"] },
  { id: "svc-108", name: "Супер комплекс (гідропілінг+ масаж+ мікротоки/EMS на вибір)", categoryId: "cat-9", durationMin: 60, price: 3700, providers: ["kovbasa"] },
  { id: "svc-109", name: "Комплекс на ліфтинг (Масаж+ мікротоки/EMS на вибір)", categoryId: "cat-9", durationMin: 60, price: 2500, providers: ["kovbasa"] },
  { id: "svc-110", name: "Супер комбо апаратні (гідропілінг з алмазним пілінгом+ мікротоки+ EMS)", categoryId: "cat-9", durationMin: 60, price: 3700, providers: ["kovbasa"] },
