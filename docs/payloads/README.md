...
Користувач обрав 2 послуги (svc-8 «Консультація дерматологічна» 60 хв + svc-9
«Консультація трихологічна» 60 хв = 120 хв), лікаря 79264 (Самоукова), час
10:00 за Києвом 23.06.2026 (= `07:00:00.000Z`), і ввів дані.
...
- `note` = назви обраних послуг (кожна з нового рядка) + коментар клієнта останнім.
- `status` = `BOOKING`.
...
| `GET /api/availability?serviceIds=svc-8,svc-9&from=…&to=…` | `get-availability.response.json` |
